...
export default async function VanBanDiDetailPage(
  props: {
  ...
  return (
    <AppShell session={session}>
      <div className="mb-4">
        <Link href="/van-ban-di" className="text-sm text-slate-500 hover:text-blue-700">
          ← Quay lại danh sách văn bản đi
        </Link>
      </div>
